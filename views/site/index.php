              ...
              <?php foreach ($articles as $article): ?>
                <article class="post">
                    <div class="post-thumb">
                        <a href="<?= Url::to(['site/read', 'id' => $article->id]);?>"><img src="<?=$article->getImage();?>" alt=""></a>

                        <a href="<?= Url::to(['site/read', 'id' => $article->id]);?>" class="post-thumb-overlay text-center">
                    ...
                    <div class="post-content">
                        ...
                        <div class="entry-content">
                            ...
                            <div class="btn-continue-reading text-center text-uppercase">
                                <a href="<?= Url::to(['site/read', 'id' => $article->id]);?>" class="more-link">Continue Reading</a>
                            </div>
                        </div>
